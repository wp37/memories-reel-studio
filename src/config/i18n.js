export const UI_STRINGS = {
  vi: {
    ...
    memories: { title: 'Tạo Reel Ký Ức Thôn Quê' },
    common: { copied: 'Đã copy thành công!' },
    nav: { spy: 'Gián Điệp', script: 'Kịch Bản', studio: 'Studio', seo: 'SEO', memories: 'Ký Ức' },
  ...
  en: {
    ...
    memories: { title: 'Memories Reel Generator' },
    common: { copied: 'Copied successfully!' },
    nav: { spy: 'Spy', script: 'Script', studio: 'Studio', seo: 'SEO', memories: 'Memories' },
