const TABS = [
  ...
  { id: 'memories', icon: 'fa-house-chimney', num: '5', label_vi: 'MEMORIES REEL', sub_vi: 'Ký Ức Thôn Quê', label_en: 'MEMORIES REEL', sub_en: 'Rural Nostalgia', color: 'text-emerald-400' },
];
